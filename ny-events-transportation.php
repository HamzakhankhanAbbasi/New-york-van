...
<section class="inner-section1">
	<div class="container">
		<div class="inner-bannerText">
			<p class="title">Ny Events Transportation</p>
...
<section class="inner-section2">
	<div class="container">
		<div class="promoPack-sectionHead text-center">
			<p class="gold-heading">Events</p>
		</div>
		<div class="row">
			<div class="col-12 col-md-6 col-lg-6 mb-4">
				<div class="event-title mb-4">
					<p>Event 1</p>
				</div>
				<div class="event-box">
					<div class="image">
						<img src="assets/images/event-img1.jpg" alt="img" class="img-fluid">
					</div>
					<div class="content">
						<p>Details</p>
					</div>
...
<div class="secBottom-heading">
	<p class="black-heading text-center">NY Events Transportation</p>
</div>
