...
<section class="inner-section1">
	<div class="container">
		<div class="inner-bannerText">
			<p class="title">NJ Bus Group Transportation</p>
		...
		<div class="row">
			<div class="col-12 col-md-7 col-lg-8">
				<div class="innerSec2-content mb-4">
					<p class="gold-heading mb-4">NJ Bus Group Transportation</p>
					<p class="paraghraph mgb-5">With just one goal in mind, New York Van has been dedicatedly serving NJ, NY and beyond with professionalism, reliability and a complete fleet of late-model vehicles and competitive rates so that you're always traveling in-style while saving the most on all your NJ Bus Group Transportation needs. Provide our clients with a royal treatment which they deserve has been our top most priority, be it for a few hours or a week long affair. When it is time to execute the safe delegated task of transportation of our customers, NJ Bus Group Transportation and Chauffeured Ground Transportation does not compromise or cut corners.</p>
					<p class="gold-heading mb-4">Bus Group Transportation NJ</p>
					<p class="paraghraph">NJ Bus Group Transportation Service has been successfully catering to all ground transportation needs, from local transfers and airport transportation to group transportation and bus Services. Unlike common transfer services, NJ Bus Group Transportation Service gives customers the option to choose from a wide array of mini coaches, shuttle and charter buses and delivers on its promises ... every time! Our extensive fleet of late-model vehicles consists of executive SUVs, executive vans, Mercedes Sprinters, mini coaches, shuttle and charter buses, capable of transferring any group size, smoothly and comfortably. Contact us today for more info, availability of vehicles and reservations.</p>
				</div>
			</div>
