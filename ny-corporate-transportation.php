...
<section class="inner-section1">
	<div class="container">
		<div class="inner-bannerText">
			<p class="title">New York Corporate Transportation</p>
		...
		<div class="row">
			<div class="col-12 col-md-7 col-lg-8">
				<div class="innerSec2-content mb-4">
					<p class="gold-heading mb-4">New York Corporate Transportation</p>
					<p class="paraghraph mgb-5">New York Van provides complete corporate transportation management services for today's leading businesses and corporate travelers. Our New York Corporate Transportation services encompass a wide variety of business class transportation and logistical support. As New York's premier corporate ground transportation service, New York Van delivers consistent, dependable and personal service. Our dedicated team understands just how important it is to provide exceptional transportation service and exceed the expectations of our corporate clients.</p>
					<p class="gold-heading mb-4">Corporate Transportation New York</p>
					<p class="paraghraph mb-3">Being on time for every trip is our top most priority</p>
					<ul class="bullet mgb-5">
						<li>24/7 Live dispatch and reservations</li>
						<li>Meet and greet services for delegates and VIP's</li>
						<li>Tools to help executive assistants and travel managers</li>
						<li>Vehicles equipped with GPS tracking</li>
						<li>Capability to integrate with corporate booking tools (GDS)</li>
						<li>Latest communication and reservation system</li>
						<li>Online access for reservations, confirmations and receipts</li>
						<li>Serving all major cities worldwide</li>
						<li>Hourly Charter - Best for meetings with multiple locations</li>
						<li>Airport transfer - Hassle free and most convenient way to and from airports</li>
					</ul>
					<p class="gold-heading mb-4">NY Corporate Transportation Service</p>
					<p class="paraghraph">Our chauffeurs are professionally trained to deliver exceptional service and meet the individual needs of each client. You will find your chauffeur well appointed, polite and professional. Our chauffeurs are dressed professionally and are well groomed. They have knowledge of the local areas and how to "get around" town when in need. Our entire team is dedicated to providing seamless ground transportation services in New York City and New Jersey. Please call us with any questions, to open an account, book a reservation or to receive a quote for service.</p>
				</div>
			</div>
			<div class="col-12 col-md-5 col-lg-4">
				<div class="innerSec2-image">
					<img src="assets/images/ny-corporate-transportation.webp" alt="img" class="img-fluid">
				</div>
			</div>
		</div>
	</div>
