...
<section class="inner-section2">
	<div class="container">
		<div class="section-title text-center">
			<p>New York <span>Chauffeured Transportation</span></p>
		</div>
		<div class="gallery-wrap">
			<div class="row">
				<div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
					<div class="gallery-image">
						<a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#gallery-modal">
							<img src="assets/images/gallery-img1.webp" alt="img" class="img-fluid">
							<span class="gallery-tag">3 Pax Sedan</span>
						</a>
					</div>
				</div>
				<div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
					<div class="gallery-image">
						<a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#gallery-modal">
							<img src="assets/images/gallery-img2.webp" alt="img" class="img-fluid">
							<span class="gallery-tag">3 Pax Sedan</span>
						</a>
					</div>
				</div>
				<div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
					<div class="gallery-image">
						<a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#gallery-modal">
							<img src="assets/images/gallery-img3.webp" alt="img" class="img-fluid">
							<span class="gallery-tag">3 Pax Sedan</span>
						</a>
					</div>
				</div>
				<div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
					<div class="gallery-image">
						<a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#gallery-modal">
							<img src="assets/images/gallery-img4.webp" alt="img" class="img-fluid">
							<span class="gallery-tag">3 Pax Sedan</span>
						</a>
					</div>
				</div>
				<div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
					<div class="gallery-image">
						<a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#gallery-modal">
							<img src="assets/images/gallery-img5.webp" alt="img" class="img-fluid">
							<span class="gallery-tag">3 Pax Sedan</span>
						</a>
					</div>
				</div>
				<div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
					<div class="gallery-image">
						<a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#gallery-modal">
							<img src="assets/images/gallery-img6.webp" alt="img" class="img-fluid">
							<span class="gallery-tag">3 Pax Sedan</span>
						</a>
					</div>
				</div>
				<div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
					<div class="gallery-image">
						<a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#gallery-modal">
							<img src="assets/images/gallery-img7.webp" alt="img" class="img-fluid">
							<span class="gallery-tag">3 Pax Sedan</span>
						</a>
					</div>
				</div>
				<div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
					<div class="gallery-image">
						<a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#gallery-modal">
							<img src="assets/images/gallery-img8.webp" alt="img" class="img-fluid">
							<span class="gallery-tag">3 Pax Sedan</span>
						</a>
					</div>
				</div>
				<div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
					<div class="gallery-image">
						<a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#gallery-modal">
							<img src="assets/images/gallery-img9.webp" alt="img" class="img-fluid">
							<span class="gallery-tag">3 Pax Sedan</span>
						</a>
					</div>
				</div>
				<div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
					<div class="gallery-image">
						<a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#gallery-modal">
							<img src="assets/images/gallery-img10.webp" alt="img" class="img-fluid">
							<span class="gallery-tag">3 Pax Sedan</span>
						</a>
					</div>
				</div>
				<div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
					<div class="gallery-image">
						<a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#gallery-modal">
							<img src="assets/images/gallery-img11.webp" alt="img" class="img-fluid">
							<span class="gallery-tag">3 Pax Sedan</span>
						</a>
					</div>
				</div>
				<div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
					<div class="gallery-image">
						<a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#gallery-modal">
							<img src="assets/images/gallery-img12.webp" alt="img" class="img-fluid">
							<span class="gallery-tag">3 Pax Sedan</span>
						</a>
					</div>
				</div>
				<div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
					<div class="gallery-image">
						<a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#gallery-modal">
							<img src="assets/images/gallery-img13.webp" alt="img" class="img-fluid">
							<span class="gallery-tag">3 Pax Sedan</span>
						</a>
					</div>
				</div>
...
<div class="secBottom-heading">
	<p class="black-heading text-center">NY Ground Transportation</p>
</div>
