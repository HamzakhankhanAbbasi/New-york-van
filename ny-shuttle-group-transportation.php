...
<section class="inner-section1">
	<div class="container">
		<div class="inner-bannerText">
			<p class="title">NY Shuttle Group Transportation</p>
	...
	<div class="container">
		<div class="row">
			<div class="col-12 col-md-7 col-lg-8">
				<div class="innerSec2-content mb-4">
					<p class="gold-heading mb-4">NY Shuttle Group Transportation</p>
					<p class="paraghraph mgb-5">Tired of dealing with mediocre, unreliable shuttle services? New York Van offers the best NY Shuttle Group Transportation Services and exceptional airport and corporate travel solution for all your chauffeured group transportation needs in New York and beyond. We are the most trusted NY Shuttle Group Transportation and New York Chauffeured Transportation Service, providing a choice of exquisite VIP style luxury buses and mini coaches, driven by professional chauffeurs who are always on-time and dress formally, yet retain those friendly old-fashion values that put customers at ease and allow them to fully appreciate their luxury group transfer experience.</p>
					<p class="gold-heading mb-4">Shuttle Group Transportation NY</p>
					<p class="paraghraph mgb-5">Our NY Shuttle Group Transportation Service caters to those who demand reliable luxury transportation, meticulously maintained luxury fleet and the most professional chauffeurs in New York. For this reason, most consider Our NY Shuttle Group Transportation services for all group travel needs. We have proven time and time again how style and comfort can come at affordable rates and with exceptional luxury group transportation services such as corporate transportation, executive travel, airport transfers and personal events.</p>
					<p class="gold-heading mb-4">New York Shuttle Group Transportation</p>
					<p class="paraghraph">Our chauffeurs are punctual, courteous and knowledgeable and above all, service oriented. Our private NY Shuttle Group Transportation service is incomparable to ordinary shuttle bus services, as we offer privacy, amenities and personal service expected from a professional first-class transportation service. We offer premium service in New York with professional and personable chauffeurs. Our extensive fleet of late-model vehicles consists of luxury executive vans, Mercedes Sprinters, mini coaches, shuttle and charter buses, capable of transferring any group size, smoothly and comfortably. Contact us today for more info, availability of vehicles and reservations.</p>
				</div>
			</div>
			<div class="col-12 col-md-5 col-lg-4">
				<div class="innerSec2-image">
					<img src="assets/images/ny-charter-bus.webp" alt="img" class="img-fluid">
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-12 col-md-12 col-lg-6 mgt-8">
				<div class="indexSec6-content">
					...
					or call us directly, we're always available!</p>
				</div>
