...
<section class="inner-section1">
	<div class="container">
		<div class="inner-bannerText">
			<p class="title">NY Private Bus Rentals</p>
		...
		<div class="row">
			<div class="col-12 col-md-7 col-lg-8">
				<div class="innerSec2-content mb-4">
					<p class="gold-heading mb-4">NY Private Bus Rentals</p>
					<p class="paraghraph mgb-5">For more than 2 decades New York Van has been providing a full chauffeur ground transportation service including NY Private Bus Rentals for local, long distance and interstate group transportation, at competitive rates. We offer a diverse fleet of late model from luxury black cars to shuttle buses and full size charter coach buses and everything in between for all your personal and group transportation in New York and beyond. Whether you plan a trip with a small or a large group, corporate or personal, we have just the right bus or motor-coach for your group size and a very competitive rate to save you the most possible on all your charter transportation as well as local transfers, VIP personal chauffeur services, group transportation and managed events transportation.</p>
					<p class="gold-heading mb-4">Private Bus Rentals NY</p>
					<p class="paraghraph mgb-5">We offer the best NY Private Bus Rentals and a custom transportation service planned according to your needs, whether you need a 55 passenger coach bus to transfer a group, a Mercedes Sprinter executive mini coach for small group up to 14 guests, a black Mercedes sedan for your own personal transportation or a complete fleet of vehicles for major events such as conventions, corporate functions, events and more. Our NY Private Bus Rentals, car service, corporate and group transportation services were all designed to provide the maximum in comfort, convenience and value. If you're currently looking for a reliable NY Private Bus Rental service then give us a call and ask about our current special offers.</p>
					<p class="gold-heading mb-4">New York Private Bus Rentals</p>
					<p class="paraghraph">New York Van is committed to offering high-quality NY Private Bus Rental and chauffeured group transportation services at an affordable price. Our extensive fleet of cars and buses includes many varieties of vehicles to fit every budget and unique need. Please contact us today for more info, availability of vehicles, current rates and specials.</p>
				</div>
			</div>
