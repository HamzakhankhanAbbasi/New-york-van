...
<section class="inner-section1">
	<div class="container">
		<div class="inner-bannerText">
			<p class="title">Promos/packages</p>
...
<section class="inner-section2">
	<div class="container">
		<div class="promoPack-sectionHead text-center">
			<p class="gold-heading">Promos/Packages</p>
		</div>
		<div class="row">
			<div class="col-12 col-md-6 col-lg-6 mb-4">
				<div class="package-box">
					<div class="package-head">
						<p>Special</p>
						<span>offer here</span>
					</div>
					<div class="package-button">
						<a href="javascript:void(0)" class="cta-btn">Book Now</a>
					</div>
					<ul>
						<li><strong>Details:</strong> details</li>
						<li><strong>PROMO CODE:</strong> promo code</li>
					</ul>
				</div>
			</div>
			<div class="col-12 col-md-6 col-lg-6 mb-4">
